...
$list_page .= '<li class="page-item"><a class="page-link" href="admin.php?page_layout=user&page='.$prev.'">&laquo;</a></li>';
// so page
for($i = 1; $i <= $total_page; $i++){
    ...
    $list_page .= '<li class="page-item '.$active.'"><a class="page-link" href="admin.php?page_layout=user&page='.$i.'">'.$i.';</a></li>';
}
//next
$next = $page + 1;
if($next >= $total_page){
...
$list_page .= '<li class="page-item"><a class="page-link" href="admin.php?page_layout=user&page='.$next.'">&raquo;</a></li>';
?>-->
                            ...
                            <tbody>
                              <!--  <?php
                                ...
                                <tr>                                   
                                    ...
                                    ?>--></td>    
                                    <td class="form-group">
                                        <a href="admin.php?page_layout=edit_user&user_id=<?php echo $row['user_id']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
