...
<title>Sphone - Administrator</title>
...
<body>
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#"><span>Sphone</span></a>
						<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($_GET['page_layout'] == 'user' || $_GET['page_layout'] == 'edit_user' || $_GET['page_layout'] == 'add_user'){echo 'active';} ?>"><a href="admin.php?page_layout=user"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>Quản lý thành viên</a></li>
			<li class="<?php if($_GET['page_layout'] == 'category' || $_GET['page_layout'] == 'edit_category' || $_GET['page_layout'] == 'add_category'){echo 'active';} ?>"><a href="admin.php?page_layout=category"><svg class="glyph stroked open folder"><use xlink:href="#stroked-open-folder"/></svg>Quản lý danh mục</a></li>
			<li class="<?php if($_GET['page_layout'] == 'product' || $_GET['page_layout'] == 'edit_product' || $_GET['page_layout'] == 'add_product' ){echo "active";} ?>"><a href="admin.php?page_layout=product"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg>Quản lý sản phẩm</a></li>
